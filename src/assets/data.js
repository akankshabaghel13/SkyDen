...
export const testimonials = [
    {
        ...
        quote: " SkyDen has transformed how our team collaborates on creative assets. The secure sharing and intuitive interface have made file management a breeze.",
        rating: 5
    },
    {
        name: "Nikhil Mehta",
        ...
        quote: "As a freelancer, I need to share large design files with clients securely. SkyDen's simple interface and reasonable pricing make it my go-to solution.",
        rating: 5
    },
    {
        name: "Priya Sharma",
        ...
        quote: "Managing project files across multiple teams used to be a nightmare until we found SkyDen. Now everything is organized and accessible exactly when we need it.",
        rating: 4
    }
];
