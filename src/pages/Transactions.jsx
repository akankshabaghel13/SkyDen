...
import {AlertCircle, BadgeIndianRupee, Loader2} from "lucide-react";
        ...
        <DashboardLayout activeMenu="Transactions">
            <div className="p-6">
                <div className="flex items-center gap-2 mb-6">
                    <BadgeIndianRupee className="text-sky-800" />
                ...
                {loading ? (
                    ...
                    <div className="bg-gray-50 p-8 rounded-lg text-center">
                        <BadgeIndianRupee size={48} className="mx-auto mb-4 text-gray-400" />
