...
const MyFiles = () => {
    ...
    const getFileIcon = (file) => {
        ...
        if (['jpg', 'jpeg', 'png', 'gif', 'svg', 'webp'].includes(extenstion)) {
            return <Image size={24} className="text-sky-600" />
        }
        ...
        return <FileIcon size={24} className="text-sky-600" />
    }
                ...
                {files.length === 0 ? (
                    <div className="bg-white rounded-lg shadow p-12 flex flex-col items-center justify-center">
                        ...
                        <button
                            ...
                            className="px-4 py-2 bg-sky-700 text-white rounded-md hover:bg-sky-900 transition-colors">
                            Go to Upload
                        </button>
                    </div>
                ): viewMode === "grid" ? (
