            ...
            <div className="p-6">
                ...
                <div className="flex flex-col md:flex-row gap-6 mb-8">
                    <div className="bg-blue-100 p-6 rounded-lg">
                        <div className="flex items-center gap-2 mb-4">
                            ...
                            <h2 className="text-lg font-medium">Current Credits: <span className="font-bold text-sky-700">{credits}</span></h2>
                        </div>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                    {plans.map((plan) => (
                        ...
                        >
                            {plan.recommended && (
                                <div className="inline-block bg-sky-700 text-white text-xs font-semibold px-3 py-1 rounded-full mb-4">
                                    RECOMMENDED
                                </div>
                            )}
                            ...
                            <button
                                ...
                                className={`w-full py-2 rounded-md font-medium transition-colors ${
                                    plan.recommended
                                        ...
                                        : 'bg-white border border-sky-700 text-sky-700 hover:bg-blue-100'
