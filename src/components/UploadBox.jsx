        ...
        <div className="w-full max-w-3xl mx-auto">
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                    <ArrowUpFromLine className="text-sky-700" size={20} />
            ...
            <div
                className="border-dashed border-2 border-gray-300 rounded-lg p-8 text-center bg-white cursor-pointer hover:border-sky-800 transition-colors"
            ...
            >
                <div className="flex flex-col items-center justify-center">
                    <div className="p-3 rounded-full bg-blue-100 mb-4">
                        <ArrowUpFromLine size={24} className="text-sky-800" />
                    </div>
            ...
            {files.length > 0 && (
                <div className="mt-4">
                    <button
                        ...
                        className="w-full py-3 bg-sky-700 text-white rounded-md hover:bg-sky-800 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                    >
                        {uploading ? (
                            <>
