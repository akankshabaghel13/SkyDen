        ...
        <div className="w-full">
            <div className="flex items-center justify-between mb-2">
                <div className="flex items-center gap-2">
                    <ArrowUpFromLine className="text-sky-900" size={18} />
            ...
            <div
                className="border-dashed border-2 border-gray-300 rounded-lg p-6 text-center bg-white cursor-pointer hover:border-sky-700 transition-colors"
            ...
            >
                <div className="flex flex-col items-center justify-center">
                    <div className="p-2 rounded-full bg-purple-50 mb-3">
                        <ArrowUpFromLine size={20} className="text-sky-700" />
                    </div>
                ...
                <div className="mt-4">
                    ...
                    <div className="bg-white rounded-lg border border-gray-200 overflow-hidden">
                        {files.map((file, index) => (
                            <div key={index} className="flex items-center justify-between p-2 border-b last:border-b-0 hover:bg-gray-100">
                                <div className="flex items-center gap-2">
                                    <FileIcon size={16} className="text-sky-800" />
                                    <div>
            ...
            {files.length > 0 && (
                <div className="mt-3">
                    <button
                        ...
                        className="w-full py-2 bg-sky-700 text-white text-sm rounded-md hover:bg-sky-900 disabled:opacity-50 flex items-center justify-center gap-2 transition-colors"
                    >
                        {uploading ? (
                            <>
