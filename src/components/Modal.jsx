...
const Modal = ({
                   ...
                   cancelText = "Cancel",
                   onConfirm,
                   confirmButtonClass = "bg-sky-700 hover:bg-sky-900",
                   size = "md"
               }) => {
            ...
            >
                ...
                <div className="px-6 py-4 border-t border-gray-200 flex justify-end space-x-3">
                    <button
                        type="button"
                        onClick={onClose}
                        className="px-4 py-2 bg-gray-100 text-gray-700 rounded-md hover:bg-gray-200 focus:outline-none focus:ring-2 focus:ring-blue-400"
                    >
                        {cancelText}
                    </button>
                    <button
